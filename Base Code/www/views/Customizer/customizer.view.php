...
<div id="sectionOneCustomizer" class="row">
    ...
    <div id="leftPartCustomizer" class="col-12 col-m-6 col-l-6">
        <a class="a-Customizer" href="<?php echo Routing::getSlug("Customizer","customMeta");?>">Customize meta on your WebSite<i class="arrowCustomizer fas fa-chevron-right"></i></a>
    </div>
</div>