...
<div id="" style="background-color: <?php echo $error->background_color;?>;"></div>
        <p id="textErrorPage" style="color:<?php echo $error->text_color;?>;"><?php echo $error->content;?></p>
        <a id="returnErrorPage" style="color:<?php echo $error->text_color;?>;" href="<?php echo Routing::getSlug("Statistics","default");?>">Return to homepage</a>
